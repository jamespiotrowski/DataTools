...
int main()
{
	...
	*/
	...
	fileName = "C:\\Users\\admin_piotrowski\\source\\repos\\DelimitedFileConverter\\TestingFiles\\Example7.txt";
	dfc = DelimitedFileConverter(fileName, "|delimiter|", "%%", true, true);
	dfc.PrintOptions();
	dfc.ProcessFile();
	malformedRows = dfc.GetMalformedRows();
	cout << "[MALFORMED ROWS] : ######################################" << endl;
	...
	fileName = "C:\\Users\\admin_piotrowski\\source\\repos\\DelimitedFileConverter\\TestingFiles\\Verisk_RandomStateSample_51147.csv";
	dfc = DelimitedFileConverter(fileName, ",", "", true, true);
	dfc.PrintOptions();
	dfc.ProcessFile();
	malformedRows = dfc.GetMalformedRows();
